...
def start_game(event):
    ...
    if NUM_LIVES <= 0:
        ...
        graphics.window.add(graphics.your_score, (graphics.window.width - graphics.your_score.width) / 2,
                            (graphics.window.height - graphics.your_score.height) / 2)
